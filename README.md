...
- **Data Sources:**  
  ...
  - [RESTCountries API](https://restcountries.com/) for country details  
- **Styling:** Custom CSS with responsive design  

### 🔧 Key Technical Features  
✔ **Dynamic GeoJSON Rendering:** Countries are rendered with unique colors and interactive hover states  
✔ **Animated Transitions:** Smooth animations enhance the user experience when selecting countries  
